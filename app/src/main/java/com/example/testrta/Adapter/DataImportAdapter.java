...
public class DataImportAdapter extends RecyclerView.Adapter<DataImportAdapter.DataVH> {
    ...
    public DataImportAdapter(Context mContext, ArrayList<Data> dataList, onClickItem listener) {
        this.mContext = mContext;
        this.dataList = dataList;
        this.listener = listener;
    }
    public DataImportAdapter(Context mContext, ArrayList<Data> dataList) {
        this.mContext = mContext;
        this.dataList = dataList;
        this.listener = listener;
    }
    ...
    public DataVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return  new DataImportAdapter.DataVH(view);
    }
